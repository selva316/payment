...
<body>
	<form name="frminvoice" action="createproduct/datainsert" method="post">
    <div id="wrapper">
      			...
      			<table class="table table-bordered table-hover">
					...
					<tbody>
						<tr>
							...
							<td><input type="text" name="price[]" id="price_1" class="form-control changesNo" autocomplete="off" ondrop="return false;" onpaste="return false;"></td>
