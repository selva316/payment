...
$(".addmore").on('click',function(){
	...
	html += '<td><input type="text" name="taxP[]" id="taxP_'+i+'" class="form-control autocomplete_txt" autocomplete="off"></td>';
	html += '<td><input type="text" name="tTax[]" id="tTax_'+i+'" class="form-control autocomplete_txt" autocomplete="off"></td>';
